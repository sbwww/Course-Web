<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="ex7.Register" %>
...
<body>
    <form id="form1" runat="server" method="get">
        <div>
            ...
            <asp:TextBox ID="usernameTextBox" runat="server" AutoPostBack="True">申博文</asp:TextBox>
            ...
            <asp:TextBox ID="passwordTextBox" runat="server" AutoPostBack="True">201883290091</asp:TextBox>
            ...
            <asp:TextBox ID="emailTextBox" runat="server" AutoPostBack="True">bwshen@nuist.edu.cn</asp:TextBox>
            ...
            <asp:DropDownList ID="yearDropDownList" runat="server" Height="15px" Width="100px" AutoPostBack="True">
                <asp:ListItem>2000</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label6" runat="server" Text="年"></asp:Label>
            <asp:DropDownList ID="monthDropDownList" runat="server" Height="15px" Width="100px" AutoPostBack="True">
                <asp:ListItem>8</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label7" runat="server" Text="月"></asp:Label>
            <asp:DropDownList ID="dayDropDownList" runat="server" Height="15px" Width="100px" AutoPostBack="True">
                <asp:ListItem>9</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label8" runat="server" Text="日"></asp:Label>
            <br />
            <asp:Label ID="Label9" runat="server" Text="职业"></asp:Label>
            <asp:ListBox ID="occupationListBox" runat="server" Height="68px" OnSelectedIndexChanged="occupationListBox_SelectedIndexChanged" AutoPostBack="True">
            ...
            <asp:TextBox ID="phoneTextBox" runat="server" AutoPostBack="True">025-12345678</asp:TextBox>
            ...
            <br />
            <asp:Button ID="confirmButton" runat="server" Text="确定" OnClick="confirmButton_Click" PostBackUrl="information.aspx" />
